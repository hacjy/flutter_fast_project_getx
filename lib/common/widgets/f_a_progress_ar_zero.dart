...
class FAProgressBarZero extends StatefulWidget {
  FAProgressBarZero({
    Key? key,
    this.currentValue = 0,
    this.maxValue = 100,
  ...
  @override
  _FAProgressBarZeroState createState() => _FAProgressBarZeroState();
}

class _FAProgressBarZeroState extends State<FAProgressBarZero>
  ...
  @override
  void didUpdateWidget(FAProgressBarZero old) {
    triggerAnimation();
...
class AnimatedProgressBar extends AnimatedWidget {
  ...
  final FAProgressBarZero widget;
