...
class CustomPopupMenuZero extends StatefulWidget {
  CustomPopupMenuZero({
    required this.child,
...
class _CustomPopupMenuState extends State<CustomPopupMenuZero> {
  RenderBox? _childBox;
          ...
          child: widget.barrierColor == Colors.transparent
              ...
              : Container(
                  ...
                  margin: EdgeInsets.only(
                      top: 0.w, bottom: getBottomHeight(context) + 105.w),
                ),
        );
      },
    );
